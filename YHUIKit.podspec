#
# Be sure to run `pod lib lint YHUIKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'YHUIKit'
  s.version          = '0.1.3'
  s.summary          = 'A short description of YHUIKit.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'YHUIKit/Classes/**/*'
  
  # s.resource_bundles = {
  #   'YHUIKit' => ['YHUIKit/Assets/*.png']
  # }
